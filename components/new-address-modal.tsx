...
export function NewAddressModal({ isOpen, onOpenChange, onOpen }: any) {
  return (
    <div>
      <Modal
        isOpen={isOpen}
            ...
            <>
              ...
              <div className="grid gap-2 grid-cols-1">
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    <Input className="col-span-1" label="Province" />
                    <Input className="col-span-1" label="City" />
                    <Input className="col-span-1" label="Barangay" />
                  </div>
                </div>
                <Input label="House No. / Street Address" />
