...
export function NewIdentificationModal({ isOpen, onOpenChange, onOpen }: any) {
  return (
    <div>
      <Modal isOpen={isOpen} onOpenChange={onOpenChange} className="p-2" size="lg">
        <ModalContent>
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1">
                Update New Identification
              </ModalHeader>
              <ModalBody className="flex justify-center">
                <div className="flex flex-row justify-evenly">
                  <button
                    type="button"
                    className="p-16 border-2 border-dashed border-gray-500"
                  >
                    Front
                  </button>
                  <button
                ...
                <div className="grid gap-2 grid-cols-1">
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <Input label="Identification Number" className="col-span-1" />

                  </div>

                  <Input label="Place Issued" />
                  <div className="grid grid-cols-2 gap-2">
                  <Input className="col-span-1" label="Date Issued" />
                  <Input className="col-span-1" label="Expiration Date" />
                  </div>
